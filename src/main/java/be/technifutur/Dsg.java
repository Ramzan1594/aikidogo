...
public abstract class Dsg {
    ...
    public static final String wh = "\u001B[37m";

    public static final String bcBlc = "\u001B[40m";
    public static final String bcRe = "\u001B[41m";
    public static final String bcGr = "\u001B[42m";
    public static final String bcYe = "\u001B[43m";
    public static final String bcBl = "\u001B[44m";
    public static final String bcPu = "\u001B[45m";
    public static final String bcCy = "\u001B[46m";
    public static final String bcWh = "\u001B[47m";
